...
--
-- Name: properties fk_typeid_types; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_typeid_types FOREIGN KEY (type_id) REFERENCES public.types(type_id);


--
-- Name: properties fkatomicnumber_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkatomicnumber_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
